            ...
            <div class="section__container container">
                                ...
                                <div class="catalog-item">
                                    ...
                                    @if($child->children)
                                        ...
                                        <div class="catalog-item__action">
                                            <a class="catalog-item__link" href="{{ $child->url }}" title="{{ $child->name }}">
                ...
                <div class="section__block">
                    <div class="section__row">
                        <div class="section__content">{!! $category->text !!}</div>
                        <div class="section__aside">
                            <a class="b-aside" href="javascript:void(0)" title="Оптовый прайс-лист">
                                ...
                                <div class="b-aside__text">Отправте заявку на получение прайс-листа на технические трубы
                                    ПНД - получите выгодные цены сейчас
                                </div>
                            </a>
                        </div>
                    </div>
